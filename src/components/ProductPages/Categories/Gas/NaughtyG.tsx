  ...
  return (
    <>
      ...
      <div className="m-auto hidden max-w-[100%] md:flex">
        <div className="relative h-[180vh] w-[35%] bg-purple-200">
          <div className="fixed left-[17.5%] top-[50%] h-[32rem] w-[20rem] -translate-x-1/2 -translate-y-1/2 bg-purple-300 p-5">
            <img
              src={gP}
              alt=""
        ...
        <div className="h-[180vh] w-[65%] bg-white">
          <div className="p-10 pt-[12rem]">
            <h1 className="text-6xl font-bold tracking-tight text-purple-500">
              PLEASURE GAS
            </h1>
            <div className="text-xl font-semibold">
              ...
              you a fresh musky cologne, with extra long lasting properties for
              summer wear.Be naughty to wear it. Carry it in your backpack,
      ...
      {/* Mobile */}
      <div className="block bg-purple-200 pt-8 md:hidden">
        <div className="m-8 bg-purple-300">
          <img src={gP} alt="" className="px-4" />
        </div>
        <div>
          <div className="p-10">
            <h1 className="text-6xl font-bold tracking-tight text-purple-500">
